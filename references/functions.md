<!-- Generated by scripts/sync.py from https://github.com/tidyverse/style/blob/2aed77e452a059f4b5c9c4a991d00ea0c5e70cab/functions.qmd -- do not edit. Licence: CC BY-SA 3.0, (c) the tidyverse team. -->

# Functions

## Naming

As well as following the general advice for object names in [Object names](syntax.md), strive to use verbs for function names:
...
Return statements should always be on their own line because they have important effects on the control flow. See also [control flow modifiers](syntax.md#control-flow-modifiers).
