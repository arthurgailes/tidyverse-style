<!-- Generated by scripts/sync.py from https://github.com/tidyverse/style/blob/2aed77e452a059f4b5c9c4a991d00ea0c5e70cab/package-files.qmd -- do not edit. Licence: CC BY-SA 3.0, (c) the tidyverse team. -->

# Files

The majority of advice in [Files](files.md) also applies to files in packages. Important differences are described below.
...
See [Documentation](documentation.md) for more thorough guidance on documenting functions
in packages.
