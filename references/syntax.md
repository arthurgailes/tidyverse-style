<!-- Generated by scripts/sync.py from https://github.com/tidyverse/style/blob/2aed77e452a059f4b5c9c4a991d00ea0c5e70cab/syntax.qmd -- do not edit. Licence: CC BY-SA 3.0, (c) the tidyverse team. -->
...
As described under [Named arguments](syntax.md#named-arguments), you can omit the argument names
...
* It is occasionally useful to use a `while` loop with an empty braced expression body to wait. As mentioned in [Braced expressions](syntax.md#braced-expressions), there should be no space within the `{}`.
